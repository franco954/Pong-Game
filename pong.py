...
while not game_over:
    ...
    jugador1 = pygame.draw.rect(
        screen, red, (player1_x_coor, player1_y_coor, player_width, player_height))
    jugador2 = pygame.draw.rect(
        screen, blue, (player2_x_coor, player2_y_coor, player_width, player_height))
    ...
    miTexto = miFuente.render(
        str(punto_player1) + " - " + str(punto_player2), 0, (white))

    velocidadPelotaFuente = pygame.font.Font(None, 18)
    velPelFuente = velocidadPelotaFuente.render(
        "Vel: " + str(round(pelota_speed_x, 2)), 0, (white))

    if (punto_player1) == 3:
        textoGanador = pygame.font.Font(None, 23)
        textoG = textoGanador.render("winner Player 1", 0, (red))
    ...
    if (punto_player2) == 3:
        textoGanador = pygame.font.Font(None, 23)
        textoG = textoGanador.render("Winner Player 2", 0, (blue))
        screen.blit(textoG, (335, 25))
        punto_player1 = 0
        punto_player2 = 0
        soundWin.play()
